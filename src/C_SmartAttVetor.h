...
\
virtual bool setVetor_forced(const SmartEnupla<TipoIterador,      double> &a_vetor){ throw std::invalid_argument("AttVetor_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); }; \
virtual bool setVetor_forced(const SmartEnupla<TipoIterador,         int> &a_vetor){ throw std::invalid_argument("AttVetor_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); }; \
virtual bool setVetor_forced(const SmartEnupla<TipoIterador,        bool> &a_vetor){ throw std::invalid_argument("AttVetor_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); }; \
virtual bool setVetor_forced(const SmartEnupla<TipoIterador, std::string> &a_vetor){ throw std::invalid_argument("AttVetor_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); }; \
virtual bool setVetor_forced(const SmartEnupla<TipoIterador,     Periodo> &a_vetor){ throw std::invalid_argument("AttVetor_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); }; \
\
...
\
	virtual bool setVetor_forced(const SmartEnupla<Periodo,       TipoRelaxacaoVariavelAleatoria> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<Periodo,       TipoDetalhamentoProducaoTermeletrica> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<Periodo,       TipoDetalhamentoProducaoHidreletrica> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<Periodo,       IdRealizacao> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<Periodo,          IdEstagio> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<IdCenario,        IdCenario> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<IdProcesso,        IdCenario> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<int,         IdHidreletrica> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<int,       IdUnidadeRealUTE> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<int,         IdTermeletrica> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<int,           IdSubmercado> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<int,          IdIntercambio> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<IdNo,          IdRealizacao> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<int,         IdCorteBenders> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<int,       IdVariavelEstado> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<int,           IdRealizacao> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
	virtual bool setVetor_forced(const SmartEnupla<IdEstagio,           TipoProcessamentoParalelo> &a_vetor){ throw std::invalid_argument(std::string(#Atributo) + std::string(#Classe) + "_Nenhum_Struct::setVetor(): \nEstrutura de dados nao definida."); return false; }; \
\
